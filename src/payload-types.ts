...
export interface Page {
  ...
  hero: {
    ...
    /**
     * Adds the the content for the Home Hero CTA
     */
    ctaHomeHero?: {
      subHeadline?: {
        root: {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ProjectsFeaturedBlock".
 */
export interface ProjectsFeaturedBlock {
  image: number | Media;
  logo: number | Media;
  sectionHeading: {
    root: {
...
export interface Product {
  id: number;
  /**
   * When enabled, this product appears in the Productos Populares carousel.
   */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ProjectsFeaturedBlock_select".
 */
export interface ProjectsFeaturedBlockSelect<T extends boolean = true> {
  image?: T;
  logo?: T;
  sectionHeading?: T;
  link?:
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ProductsFeaturedBlock_select".
 */
export interface ProductsFeaturedBlockSelect<T extends boolean = true> {
  heading?: T;
  ctaLink?:
    | T
    | {
